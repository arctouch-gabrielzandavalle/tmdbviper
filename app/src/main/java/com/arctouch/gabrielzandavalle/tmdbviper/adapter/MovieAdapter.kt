...
import com.arctouch.gabrielzandavalle.tmdbviper.home.HomeActivity
...
open class MovieAdapter(var movies: List<Movie>, val homeActivity: HomeActivity) : RecyclerView.Adapter<MovieAdapter.ViewHolder>() {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    return ViewHolder(context, view, homeActivity)
  }
  ...
  class ViewHolder(val context: Context, val view : View, val homeActivity: HomeActivity) : RecyclerView.ViewHolder(view) {
    ...
    fun bind(item: Movie) {
      ...
      view.setOnClickListener {
        homeActivity.homePresenterInput.itemClicked(item.id)
      }
    }
  }
}
